...
while True:
    ...
    if not (islem=="1" or islem=="2" or islem=="3" or islem==4):
        ...
        while True:
            ...
            break
        while True:
            q_10=input("10. QUIZ NOTU:").replace(",",".")
            if bool(q_10)==False:
                break
            elif q_10.split()==["q"]:
                print("\n CIKILIYOR..\n")
            ...
            break
        while True:
            q_11=input("11. QUIZ NOTU:").replace(",",".")
            if bool(q_11)==False:
                break
            elif q_11.split()==["q"]:
                print("\n CIKILIYOR..\n")
            ...
            break
        while True:
            q_12=input("12. QUIZ NOTU:").replace(",",".")
            if bool(q_12)==False:
                break
            elif q_12.split()==["q"]:
                print("\n CIKILIYOR..\n")
            ...
            break
        while True:
            q_13=input("13. QUIZ NOTU:").replace(",",".")
            if bool(q_13)==False:
                break
            elif q_13.split()==["q"]:
               print("\n CIKILIYOR..\n")
            ...
            break
        while True:
            q_14=input("14. QUIZ NOTU:").replace(",",".")
            if bool(q_14)==False:
                break
            elif q_14.split()==["q"]:
                print("\n CIKILIYOR..\n")
...
""".format(str(ort)[:4]))
        ...
        if ort<45:
	     ...
	     #________________________________		     #
             ...
             √ 2. donemki not ortalaman en az {} olmali4|    #
