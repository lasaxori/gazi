...
kmavi+'             ||========================================||  ',
'             ||                                        ||',
'             ||'+G+'    OTOMATİK HIZLI HESAPLAMA ICIN   "'+s+'1'+G+'" '+kmavi+'||',
'             ||'+G+'     MANUEL YAVAS HESAPLAMA ICIN    "'+s+'2'+G+'" '+kmavi+'||',
'             ||'+G+'  GAZI HOCALARI HAKKINDA BILGI ICIN "'+s+'3'+G+'" '+kmavi+'||',
...
while True:
   ...
   # os.system("clear")
    ...
    oc=1
    oc2=1
    islem=raw_input("islem no: ").replace(" ","")
    ...
    if islem=="1":
        os.system("python2 ygazi.py")
        continue
    if islem=="2":
        for ana in eski_tablo:
            print(ana)
            time.sleep(0.031)
        for ana in menu2:
            print(ana)
        ...
        while True:
            ...
            if islem=="3":
                ...
                break
            if islem=="g" or islem=="G" or islem=='q' or islem=="Q":
                break
