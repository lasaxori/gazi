        ...
        cikmak icin="q"
          ...
          """)
            for i in h:
                print(i)
            print("""
          LISTEYI TEKRAR YAZDIRMAK ICIN 'liste' yaziniz
          """)
            while True:
                ist=input("\n\n NUMARAYI GIRINIZ: ")
                if ist=="q":
                ...
                if ist=="liste":
                    for i in h:
                        print(i)
                        continue
                elif not 10>int(ist)>0:
                    print("""
                    
                    Eslesme yapilamadi
                    Dogru sayiyi girdiginden emin ol
                    """)
                    continue
                else:
                    break
            for i in b:
                ...
                if i[0]==ist:
                    if i[1]=="E":
                        print(sablon.format(i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],[10]))
                        input("[ent]")
                        continue
                    if i[1]=="K":
                        print(sablon_k.format(i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11]))
                        input("[ent]")
                        continue
