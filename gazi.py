...
""".format(str(ort_net)[:4],str((750*3*14-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q))[:4]))
...
""".format(str(ort_net)[:4],str((750*3*14-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q))[:4]))
		...
		#_____________________________________________ #
		 ##############################################
""".format(str((600*70-280*ilkd-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q))[:4],str(ort_net)[:4]))
		...
		√ simdiki sinavlardan en az {} almalisin|      #
		 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#######
""".format(str(ort_net)[:4],str((600*70-280*ilkd-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q))[:4]))
            raw_input("[ent]")
            continue
    
        elif ort_net<60 and (600*70-280*ilkd-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q)>100:
            print("""
...
""".format(str(ort_net)[:4],str((750*3*14-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q))[:4]))
		...
		#_____________________________________________ #
		 ##############################################
""".format(str(ort_net)[:4],str((600*70-280*ort_1-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q))[:4]))
        raw_input("[ent]")
        continue
    elif 60>ort_net>=50:
...
""".format(str(ort_net)[:4],str((600*70-280*ort_1-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q))[:4]))
    ...
    elif ort_net<60 and (600*70-280*ort_1-98*vize_t-9*quiz_t)/(98*kalan_v+9*kalan_q)>100:
        print("""
