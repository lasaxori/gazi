...
with requests.Session() as ses:
    ...
    try:
       r = ses.post(url, allow_redirects=True, data=data, timeout=10)
    except:
    ...
    rrr=ses.get(url_quiz, allow_redirects=True , headers=r.headers, timeout=15)
    
    print(G+' quiz notlari alindi     %60')
    icerik_quiz=rrr.text.encode('utf-8')
    print(S+'\n vize notlari aliniyor..')
    rr=ses.get(url_vize, allow_redirects=True , headers=r.headers, timeout=15)
